        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShipToAddress_Name = table.Column<string>(type: "TEXT", nullable: true),
                    ShipToAddress_Street = table.Column<string>(type: "TEXT", nullable: true),
                    ShipToAddress_Ward = table.Column<string>(type: "TEXT", nullable: true),
                    ShipToAddress_District = table.Column<string>(type: "TEXT", nullable: true),
